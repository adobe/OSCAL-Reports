...
**Usage and variables:** See [docs/DEPLOYMENT_AND_OPERATIONS.md](../docs/DEPLOYMENT_AND_OPERATIONS.md#aws-terraform-for-oscal-ai-via-bedrock).
...
**Image Factory EMR (InfraSec):** To list candidate **Amazon Linux 2023 EMR** AMIs launchable in your account, run [scripts/list-emr-candidate-amis.sh](scripts/list-emr-candidate-amis.sh) with AWS credentials (see [docs/DEPLOYMENT_AND_OPERATIONS.md – Image Factory](../docs/DEPLOYMENT_AND_OPERATIONS.md#adobe-image-factory-ami-usage-for-terraform) and [envs/aws4403/README.md](envs/aws4403/README.md) § SSAAU-169).
